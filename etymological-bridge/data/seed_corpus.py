# -*- coding: utf-8 -*-
"""
Curated Seed Corpus for Etymological Bridge
Detailed linguistic database with 35+ prime Sanskrit/Pali loanwords in Thai
mapped through Proto-Indo-European (PIE) roots to English cognates.
"""
...
ENTRIES = [
    ...
    # 2. หมวดร่างกายและการแพทย์ (Anatomy & Medicine)
    {
        ...
        "semantic_drift_note": "ในภาษาไทยใช้ในคำประสมระดับทางการ เช่น ทันตแพทย์ ทันตกรรม ทันตแพทยศาสตร์ ในภาษาอังกฤษใช้ใน dental, dentist และ dandelion!",
        "pie_branch_split": {
    ...
    },
    {
        "thai_word": "เอก",
        "category": "ตัวเลขและคณิตศาสตร์",
        "pali_sanskrit_form": "eka (एक)",
        "pali_sanskrit_lang": "Sanskrit",
        "pali_sanskrit_meaning": "one, single, solitary, unique",
        "pie_root": "*óy-kos (จากราก *óy- หนึ่งเดียว)",
        "pie_meaning": "one, alone",
        "sound_change_law": "Pronominal base *oy- พัฒนาเป็นสันสกฤต eka และเจอร์แมนิก *ainaz (*oy-no- → one, alone, only)",
        "semantic_drift_score": "None (หนึ่ง/เอกเทศ/เอกลักษณ์)",
        "semantic_drift_note": "เอก (เอกชน, เอกสาร, เอกลักษณ์, ปริญญาเอก) ↔ one, alone, only",
        "pie_branch_split": {
            "indo_iranian": "PIE *óy-kos → Sanskrit eka → ภาษาไทย 'เอก, เอกเทศ, เอกภาพ'",
            "germanic": "PIE *óy-nos → Proto-Germanic *ainaz → Old English ān → English one, alone, only"
        },
        "english_cognates": [
            {
                "word": "one",
                "derivation_path": "PIE *óy-nos → Proto-Germanic *ainaz → Old English ān",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "เอก ↔ one: รากจำนวนหนึ่งเดียวของภาษาบรรพบุรุษ"
            },
            {
                "word": "alone",
                "derivation_path": "Old English all + ān (one) = all one (อยู่เพียงลำพัง)",
                "origin_language": "Old English",
                "difficulty": "General (A2)",
                "usage_note": "ตามลำพัง / โดดเดี่ยว (ตรงกับ 'เอกเทศ')"
            },
            {
                "word": "only",
                "derivation_path": "Old English ānlic (one-like) → English only",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "เพียงหนึ่งเดียวเท่านั้น"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*óy-kos", "meaning": "one"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "eka (एक)", "meaning": "one, single"},
            {"era": "Modern Thai", "stage": "Thai", "form": "เอก", "meaning": "หนึ่ง, สำคัญที่สุด"},
            {"era": "Modern English", "stage": "English", "form": "one, alone, only", "meaning": "หนึ่งเดียว"}
        ]
    },
    {
        "thai_word": "ทวิ",
    ...
    },
    {
        "thai_word": "สัปต",
        "category": "ตัวเลขและคณิตศาสตร์",
        "pali_sanskrit_form": "sapta (सप्त)",
        "pali_sanskrit_lang": "Sanskrit",
        "pali_sanskrit_meaning": "seven",
        "pie_root": "*septḿ̥",
        "pie_meaning": "seven",
        "sound_change_law": "Grimm's Law: PIE *p- กลายเสียงเป็น fricative *f- ในเจอร์แมนิก (*septḿ̥ → *sebun → seven) และเสียง *s- กลายเป็น h- ในภาษากรีก (hepta)",
        "semantic_drift_score": "None (จำนวนเจ็ด)",
        "semantic_drift_note": "สัปต/สัปดาห์ (รอบ 7 วัน) ↔ seven, September (เดือนที่ 7 ในปฏิทินโรมันเดิม)",
        "pie_branch_split": {
            "indo_iranian": "PIE *septḿ̥ → Sanskrit sapta → ภาษาไทย 'สัปต, สัปดาห์'",
            "hellenic": "PIE *septḿ̥ → Greek hepta (ἑπτά) → English heptagon",
            "italic": "PIE *septḿ̥ → Latin septem → English September, septet",
            "germanic": "PIE *septḿ̥ → Proto-Germanic *sebun → Old English seofon → English seven"
        },
        "english_cognates": [
            {
                "word": "seven",
                "derivation_path": "PIE *septḿ̥ → Proto-Germanic *sebun → Old English seofon",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "สัปต- ↔ seven: รากเจ็ดเดียวกัน"
            },
            {
                "word": "September",
                "derivation_path": "Latin septem (เจ็ด) → English September",
                "origin_language": "Latin",
                "difficulty": "General (A1)",
                "usage_note": "กันยายน เดิมคือเดือนที่ 7 ในปฏิทินโรมันโบราณ (ราก สัปต-)"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*septḿ̥", "meaning": "seven"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "sapta (सप्त)", "meaning": "seven"},
            {"era": "Modern Thai", "stage": "Thai", "form": "สัปต / สัปดาห์", "meaning": "เจ็ด, สัปดาห์ (๗ วัน)"},
            {"era": "Modern English", "stage": "English", "form": "seven, September", "meaning": "จำนวนเจ็ด"}
        ]
    },
    {
        "thai_word": "อัฐ",
        "category": "ตัวเลขและคณิตศาสตร์",
        "pali_sanskrit_form": "aṣṭa (अष्ट)",
        "pali_sanskrit_lang": "Sanskrit",
        "pali_sanskrit_meaning": "eight",
        "pie_root": "*oḱtṓw",
        "pie_meaning": "eight",
        "sound_change_law": "Grimm's Law: PIE palatovelar *ḱ- กลายเสียงเป็น *h- ในเจอร์แมนิก (*oḱtṓw → *ahtōu → eight) และกลายเป็น ṣṭ ในสันสกฤต (aṣṭa) และ ct ในละติน (octo)",
        "semantic_drift_score": "None (จำนวนแปด) + หน่วยเงินไทยโบราณ 1 อัฐ (1/8 เฟื้อง)",
        "semantic_drift_note": "อัฐ (อัฏฐังคิกมรรค = มรรคแปด, อัฐทิศ, อัฒจันทร์, เงินอัฐ) ↔ eight, octave, octagon, October, octopus!",
        "pie_branch_split": {
            "indo_iranian": "PIE *oḱtṓw → Sanskrit aṣṭa → Pali aṭṭha → ภาษาไทย 'อัฐ, อัฏฐ-'",
            "hellenic": "PIE *oḱtṓw → Greek oktō (ὀκτώ) → English octopus (แปดเท้า!), octagon",
            "italic": "PIE *oḱtṓw → Latin octō → English octave, October (เดือนที่ 8 ในปฏิทินโรมันเดิม!)",
            "germanic": "PIE *oḱtṓw → Proto-Germanic *ahtōu → Old English eahta → English eight"
        },
        "english_cognates": [
            {
                "word": "eight",
                "derivation_path": "PIE *oḱtṓw → Proto-Germanic *ahtōu → Old English eahta",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "อัฐ ↔ eight: รากแปดเดียวกัน"
            },
            {
                "word": "octave",
                "derivation_path": "PIE *oḱtṓw → Latin octava (ช่วงแปดเสียงดนตรี) → English octave",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B1)",
                "usage_note": "ช่วงคู่แปดเสียงดนตรีโด-เร-มี-ฟา-ซอล-ลา-ที-โด"
            },
            {
                "word": "October",
                "derivation_path": "Latin octo (แปด) → English October",
                "origin_language": "Latin",
                "difficulty": "General (A1)",
                "usage_note": "ตุลาคม เดิมคือเดือนที่ 8 ของปฏิทินโรมัน"
            },
            {
                "word": "octopus",
                "derivation_path": "Greek oktō (แปด/อัฐ) + pous (เท้า/บาท) → English octopus",
                "origin_language": "Greek",
                "difficulty": "General (A2)",
                "usage_note": "ปลาหมึกยักษ์ (สัตว์แปดเท้า = อัฐ + บาท)"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*oḱtṓw", "meaning": "eight"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "aṣṭa (अष्ट)", "meaning": "eight"},
            {"era": "Modern Thai", "stage": "Thai", "form": "อัฐ / อัฏฐ-", "meaning": "แปด"},
            {"era": "Modern English", "stage": "English", "form": "eight, octave, October, octopus", "meaning": "จำนวนแปด"}
        ]
    },
    {
        "thai_word": "ทศ",
    ...
    },
    {
        "thai_word": "ปรัชญา",
        "category": "ปัญญา วิทยาศาสตร์ และความคิด",
        "pali_sanskrit_form": "prajñā (प्रज्ञा) / paññā (ปัญญา ในภาษาบาลี)",
        "pali_sanskrit_lang": "Sanskrit / Pali",
        "pali_sanskrit_meaning": "wisdom, intellect, supreme understanding (pra- ข้างหน้า + jñā รู้)",
        "pie_root": "*pro- (ข้างหน้า) + *ǵneh₃- (รู้)",
        "pie_meaning": "fore-knowledge, to know beforehand",
        "sound_change_law": "Compound stability: อุปสรรค pra- (PIE *pro-) ผสมกับธาตุ jñā (PIE *ǵneh₃-) ให้ความหมายว่า 'การรู้แจ้งล่วงหน้า' ในภาษากรีกคือ prognosis ส่วนในไทยคือ ปรัชญา (สันสกฤต) หรือ ปัญญา (บาลี)!",
        "semantic_drift_score": "Low (การรู้แจ้งเห็นจริง → วิชาปรัชญา/Philosophy)",
        "semantic_drift_note": "ปรัชญา ในภาษาไทยราชบัณฑิตยสภาบัญญัติใช้เทียบกับ Philosophy แต่ในเชิงรากศัพท์ prajñā ตรงกับคำว่า 'prognosis' และ 'precognition'!",
        "pie_branch_split": {
            "indo_iranian": "PIE *pro- + *ǵneh₃- → Sanskrit prajñā → Pali paññā → ภาษาไทย 'ปรัชญา, ปัญญา'",
            "hellenic": "PIE *pro- + *ǵneh₃- → Greek prognosis (πρόγνωσις) → English prognosis",
            "italic": "PIE *pro- + *ǵneh₃- → Latin praecognitio → English precognition"
        },
        "english_cognates": [
            {
                "word": "prognosis",
                "derivation_path": "Greek pro- (ข้างหน้า) + gnosis (รู้) → English prognosis",
                "origin_language": "Greek",
                "difficulty": "Intermediate / Medical (B2)",
                "usage_note": "การพยากรณ์โรค (การรู้ผลล่วงหน้า โครงสร้าง pra-jñā เดียวกับ ปรัชญา!)"
            },
            {
                "word": "precognition",
                "derivation_path": "Latin prae- (ก่อน/หน้า) + cognitio (การรู้) → English precognition",
                "origin_language": "Latin",
                "difficulty": "Advanced (C1)",
                "usage_note": "การล่วงรู้ล่วงหน้า (ญาณหยั่งรู้อนาคต)"
            }
        ],
        "timeline": [
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "prajñā (प्रज्ञा)", "meaning": "supreme wisdom, insight"},
            {"era": "Modern Thai", "stage": "Thai", "form": "ปรัชญา / ปัญญา", "meaning": "วิชาว่าด้วยหลักแห่งความรู้และความจริง"}
        ]
    },
    {
        "thai_word": "มโน",
    ...
    },
    {
        "thai_word": "จันทร์",
        "category": "ธรรมชาติ สรรพสิ่ง และจักรวาล",
        "pali_sanskrit_form": "candra (चन्द्र)",
        "pali_sanskrit_lang": "Sanskrit (จากราก ścand- เปล่งประกายสุกสว่าง)",
        "pali_sanskrit_meaning": "shining, moon, luminous",
        "pie_root": "*(s)kand-",
        "pie_meaning": "to shine, glow white, bright",
        "sound_change_law": "Palatalization: ราก *(s)kand- ส่องสว่างสีขาว กลายเป็นสันสกฤต candra (ดวงจันทร์สีนวล) และละติน candēre (ส่องสว่าง) → candela (เทียนไข) → candle, candid, candidate",
        "semantic_drift_score": "Medium (แสงสว่างสีขาว → ดวงจันทร์ / ผู้สมัครที่สวมชุดขาว)",
        "semantic_drift_note": "จันทร์ (ดวงจันทร์, จันทรา) ↔ candle (เทียนส่องสว่าง), candid (ขาวสะอาด/ตรงไปตรงมา), candidate (ผู้สวมชุดขาวลงสมัครรับเลือกตั้งในโรมโบราณ!)",
        "pie_branch_split": {
            "indo_iranian": "PIE *(s)kand- → Sanskrit candra → ภาษาไทย 'จันทร์, จันทรา, ศศิธร'",
            "italic": "PIE *(s)kand- → Latin candēre → English candle, candid, candidate, incandescent"
        },
        "english_cognates": [
            {
                "word": "candle",
                "derivation_path": "PIE *(s)kand- → Latin candela (สิ่งส่องสว่างสีขาว) → Old English candel",
                "origin_language": "Latin / Old English",
                "difficulty": "General (A1)",
                "usage_note": "เทียนไข (สิ่งที่เปล่งแสงนวลสว่างดุจแสงจันทร์)"
            },
            {
                "word": "candidate",
                "derivation_path": "PIE *(s)kand- → Latin candidatus (ผู้สวมชุดสีขาวบริสุทธิ์เพื่อสมัครรับเลือกตั้งในสภาโรม) → English candidate",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B1)",
                "usage_note": "ว้าว! candidate (ผู้สมัครรับเลือกตั้ง) เดิมแปลว่า 'ผู้สวมชุดสีขาวผ่อง' มาจากรากแสงจันทร์ *(s)kand-!"
            },
            {
                "word": "candid",
                "derivation_path": "PIE *(s)kand- → Latin candidus (ขาวผุดผ่อง/ไร้มลทิน) → English candid",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B2)",
                "usage_note": "ตรงไปตรงมา / บริสุทธิ์ใจ (เช่น candid opinion)"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*(s)kand-", "meaning": "to glow white"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "candra (चन्द्र)", "meaning": "moon, glittering"},
            {"era": "Modern Thai", "stage": "Thai", "form": "จันทร์ / จันทรา", "meaning": "ดวงจันทร์"},
            {"era": "Modern English", "stage": "English", "form": "candle, candidate, candid", "meaning": "เทียน, ผู้สมัคร, ตรงไปตรงมา"}
        ]
    },
    {
        "thai_word": "ดารา",
    ...
    },
    {
        "thai_word": "วายุ",
        "category": "ธรรมชาติ สรรพสิ่ง และจักรวาล",
        "pali_sanskrit_form": "vāyu (वायु) / vāta (วาต/วาตภัย)",
        "pali_sanskrit_lang": "Sanskrit",
        "pali_sanskrit_meaning": "wind, air, blowing god",
        "pie_root": "*h₂wéh₁- (หรือ *we- / *wē-nt-)",
        "pie_meaning": "to blow (ลมพัด)",
        "sound_change_law": "Participle formation: ราก *h₂wéh₁- (พัด) ผันเป็น active participle *wē-nt- (ตัวที่พัด) ให้กำเนิดสันสกฤต vāta (วาตภัย) และเจอร์แมนิก wind",
        "semantic_drift_score": "Low (ลมพัด → สภาพอากาศ/หน้าต่างรับลม)",
        "semantic_drift_note": "วายุ/วาต (วาตภัย) ↔ wind, weather, window (ช่องลมเข้าตาบ้าน!), ventilate",
        "pie_branch_split": {
            "indo_iranian": "PIE *h₂wéh₁- → Sanskrit vāyu / vāta → ภาษาไทย 'วายุ, วาตภัย'",
            "italic": "PIE *h₂wéh₁- → Latin ventus → English ventilate",
            "germanic": "PIE *h₂wéh₁- → Proto-Germanic *windaz → Old English wind → English wind, weather, window (wind-eye ช่องรับลม!)"
        },
        "english_cognates": [
            {
                "word": "wind",
                "derivation_path": "PIE *wē-nt- → Proto-Germanic *windaz → Old English wind",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "ลม / วายุ ↔ wind"
            },
            {
                "word": "window",
                "derivation_path": "Old Norse vindr (ลม/วายุ) + auga (ตา) = ช่องตาของบ้านสำหรับรับลม!",
                "origin_language": "Old Norse",
                "difficulty": "General (A1)",
                "usage_note": "ว้าว! window แปลว่า 'ดวงตารับสายลม' (wind-eye) รากเดียวกับ วายุ!"
            },
            {
                "word": "ventilate",
                "derivation_path": "PIE *wē-nt- → Latin ventilare (พัดลม) → English",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B2)",
                "usage_note": "ระบายอากาศ (ให้อากาศวายุถ่ายเท)"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*h₂wéh₁- / *wē-nt-", "meaning": "to blow, wind"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "vāyu (वायु) / vāta", "meaning": "wind, air"},
            {"era": "Modern Thai", "stage": "Thai", "form": "วายุ / วาตภัย", "meaning": "ลม, ภัยจากลมพายุ"},
            {"era": "Modern English", "stage": "English", "form": "wind, window, ventilate", "meaning": "สายลม, หน้าต่าง"}
        ]
    },
    ...
    },
    {
        "thai_word": "สถาน",
        "category": "ชีวิต วิญญาณ และการดับสูญ",
        "pali_sanskrit_form": "sthāna (स्थान) / sthiti (สถิต)",
        "pali_sanskrit_lang": "Sanskrit",
        "pali_sanskrit_meaning": "standing place, site, abode, staying",
        "pie_root": "*steh₂-",
        "pie_meaning": "to stand, stand firm",
        "sound_change_law": "Grimm's Law exemption: กลุ่มพยัญชนะ st- ได้รับการยกเว้นจากกฎกริมม์ ทำให้คงรูป st- เหมือนกันทั้งใน Sanskrit (sthāna), Latin (status), และ English (stand, state, station)!",
        "semantic_drift_score": "Low (การยืนอยู่ → สถานที่ → สถานะ/รัฐ)",
        "semantic_drift_note": "สถาน/สถิต/สถาบัน/สถานี/สถานการณ์ ↔ stand, state, station, statue, stable, establish, instant, distance",
        "pie_branch_split": {
            "indo_iranian": "PIE *steh₂- → Sanskrit sthāna / sthiti → ภาษาไทย 'สถาน, สถิต, สถานี, สถานภาพ'",
            "hellenic": "PIE *steh₂- → Greek histanai → English static, ecstasy, system",
            "italic": "PIE *steh₂- → Latin stāre (ยืน) / status → English state, station, statue, stable, establish",
            "germanic": "PIE *steh₂- → Proto-Germanic *standaną → Old English standan → English stand, standard"
        },
        "english_cognates": [
            {
                "word": "stand",
                "derivation_path": "PIE *steh₂- → Proto-Germanic *standaną → Old English standan",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "สถิต/สถาน ↔ stand: ราก 'ยืนหยัด' ตัวเดียวกัน"
            },
            {
                "word": "state",
                "derivation_path": "PIE *steh₂- → Latin status (สภาวะการยืนหยัด/สถานะ) → English state",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B1)",
                "usage_note": "รัฐ / สถานะ / สภาพ (รากเดียวกับ สถานภาพ)"
            },
            {
                "word": "station",
                "derivation_path": "PIE *steh₂- → Latin statio (ที่จอดพัก/สถานี) → English station",
                "origin_language": "Latin",
                "difficulty": "General (A1)",
                "usage_note": "สถานี (คำทับศัพท์ที่แปลตรงราก สถาน เดิม!)"
            },
            {
                "word": "statue",
                "derivation_path": "PIE *steh₂- → Latin statua (รูปปั้นยืน) → English statue",
                "origin_language": "Latin",
                "difficulty": "General (A2)",
                "usage_note": "รูปปั้นอนุสาวรีย์"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*steh₂-", "meaning": "to stand"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "sthāna (स्थान)", "meaning": "place, standing"},
            {"era": "Modern Thai", "stage": "Thai", "form": "สถาน / สถิต / สถานี", "meaning": "ที่ตั้ง, ตั้งอยู่"},
            {"era": "Modern English", "stage": "English", "form": "stand, state, station, statue", "meaning": "ยืน, รัฐ, สถานี, รูปปั้น"}
        ]
    },
    {
        "thai_word": "ธรรม",
        "category": "ชีวิต วิญญาณ และการดับสูญ",
        "pali_sanskrit_form": "dharma (धर्म) / dhamma (ธัมม์ ในภาษาบาลี)",
        "pali_sanskrit_lang": "Sanskrit / Pali",
        "pali_sanskrit_meaning": "law, duty, righteousness, that which holds firm (จากราก dhṛ- ทรงไว้)",
        "pie_root": "*dʰer- (หรือ *dʰer-gʰ-)",
        "pie_meaning": "to hold firmly, support, sustain",
        "sound_change_law": "Aspiration loss: PIE voiced aspirated stop *dʰ- พัฒนาเป็นสันสกฤต dh- (dharma) และละติน f- (firmus) ทำให้ Sanskrit dharma กลายเป็น English firm!",
        "semantic_drift_score": "Low (การยึดถือ/ค้ำจุนอย่างมั่นคง → กฎธรรมชาติ/คุณธรรม)",
        "semantic_drift_note": "ธรรม (ความจริงอันมั่นคงที่ค้ำจุนจักรวาล) ↔ firm (มั่นคง), affirm (ยืนยันความจริง), throne (บัลลังก์ที่ค้ำจุนราชอำนาจ), farm (ที่ดินที่มั่นคง)",
        "pie_branch_split": {
            "indo_iranian": "PIE *dʰer- → Sanskrit dharma → Pali dhamma → ภาษาไทย 'ธรรม, ธรรมาภิบาล, คุณธรรม'",
            "hellenic": "PIE *dʰer- → Greek thronos (บัลลังก์ที่รองรับ) → English throne",
            "italic": "PIE *dʰer- → Latin firmus (มั่นคงแข็งแกร่ง) → English firm, affirm, confirm, farm"
        },
        "english_cognates": [
            {
                "word": "firm",
                "derivation_path": "PIE *dʰer- → Latin firmus (มั่นคง/ยึดไว้แน่น) → English firm",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B1)",
                "usage_note": "มั่นคง / แน่วแน่ (ปรัชญาธรรมะ คือสิ่งที่มั่นคงไม่แปรผันตามกิเลส)"
            },
            {
                "word": "affirm",
                "derivation_path": "PIE *dʰer- → Latin affirmare (ยืนยันความจริงแท้) → English affirm",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B2)",
                "usage_note": "ยืนยันความจริง (เทียบเคียงการยืนยันในสัจธรรม)"
            },
            {
                "word": "throne",
                "derivation_path": "PIE *dʰer- → Greek thronos (ที่นั่งค้ำจุนผู้ปกครอง) → English throne",
                "origin_language": "Greek",
                "difficulty": "Intermediate (B1)",
                "usage_note": "บัลลังก์ (สิ่งที่รองรับค้ำจุนผู้มีอำนาจธรรม)"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*dʰer-", "meaning": "to support, hold firm"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "dharma (धर्म)", "meaning": "cosmic order, duty, virtue"},
            {"era": "Modern Thai", "stage": "Thai", "form": "ธรรม / ธรรมะ", "meaning": "คุณความดี, กฎธรรมชาติ"},
            {"era": "Modern English", "stage": "English", "form": "firm, affirm, throne", "meaning": "มั่นคง, ยืนยัน, บัลลังก์"}
        ]
    },
    ...
    # 8. หมวดการกระทำ สรรสร้าง สัตว์ และคุณลักษณะ (Attributes & Actions)
    {
        "thai_word": "นวัตกรรม",
        "category": "การกระทำและคุณลักษณะ",
    ...
    },
    {
        "thai_word": "โค",
        "category": "การกระทำและคุณลักษณะ",
        "pali_sanskrit_form": "go (गो)",
        "pali_sanskrit_lang": "Sanskrit",
        "pali_sanskrit_meaning": "cow, ox, cattle",
        "pie_root": "*gʷōws",
        "pie_meaning": "cattle, cow, bull",
        "sound_change_law": "Grimm's Law: PIE labiovelar *gʷ- กลายเสียงเป็น *k- ในเจอร์แมนิก (*gʷōws → *kōz → cow) และกลายเป็น b- ในละติน/กรีก (bōs → bovine, beef, butter)",
        "semantic_drift_score": "None (วัว/โค)",
        "semantic_drift_note": "โค (โคบาล, โคกระบือ) ↔ cow, bovine, beef, butter (bou-tyron = เนยไขมันโค!)",
        "pie_branch_split": {
            "indo_iranian": "PIE *gʷōws → Sanskrit go → ภาษาไทย 'โค, โคบาล, โคตร'",
            "hellenic": "PIE *gʷōws → Greek bous → English butter (bou-tyron เนยจากวัว), bucolic",
            "italic": "PIE *gʷōws → Latin bōs / bovis → English bovine, beef (เนื้อวัว)",
            "germanic": "PIE *gʷōws → Proto-Germanic *kōz (Grimm's Law *gʷ→*k) → Old English cū → English cow"
        },
        "english_cognates": [
            {
                "word": "cow",
                "derivation_path": "PIE *gʷōws → Proto-Germanic *kōz → Old English cū",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "โค ↔ cow: รากวัวสายพันธุ์เดิม"
            },
            {
                "word": "bovine",
                "derivation_path": "PIE *gʷōws → Latin bovinus → English",
                "origin_language": "Latin",
                "difficulty": "Intermediate / Science (B2)",
                "usage_note": "เกี่ยวกับสัตว์ตระกูลโค (เช่น bovine disease)"
            },
            {
                "word": "beef",
                "derivation_path": "PIE *gʷōws → Latin bos → Old French boef → English beef",
                "origin_language": "Old French",
                "difficulty": "General (A1)",
                "usage_note": "เนื้อวัว"
            },
            {
                "word": "butter",
                "derivation_path": "Greek bous (โค) + tyros (ชีส) → boutyron → Latin butyrum → English butter",
                "origin_language": "Greek / Latin",
                "difficulty": "General (A1)",
                "usage_note": "ว้าว! butter (เนย) ดั้งเดิมแปลว่า 'ชีสไขมันโค' (bous + tyros)!"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*gʷōws", "meaning": "cow, cattle"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "go (गो)", "meaning": "cow, ox"},
            {"era": "Modern Thai", "stage": "Thai", "form": "โค", "meaning": "วัว"},
            {"era": "Modern English", "stage": "English", "form": "cow, bovine, beef, butter", "meaning": "วัว, เนื้อวัว, เนย"}
        ]
    },
    {
        "thai_word": "อัศวะ",
        "category": "การกระทำและคุณลักษณะ",
        "pali_sanskrit_form": "aśva (अश्व) / assa (บาลี)",
        "pali_sanskrit_lang": "Sanskrit / Pali",
        "pali_sanskrit_meaning": "horse, steed",
        "pie_root": "*h₁éḱwos",
        "pie_meaning": "horse, swift runner",
        "sound_change_law": "Grimm's Law: PIE *h₁éḱwos กลายเป็นสันสกฤต aśva, ละติน equus, กรีก hippos, และโอลด์อิงลิช eoh",
        "semantic_drift_score": "None (ม้า/ผู้ขี่ม้า)",
        "semantic_drift_note": "อัศวะ/อัศวิน (ผู้ขี่ม้า/knight) ↔ equine, equestrian",
        "pie_branch_split": {
            "indo_iranian": "PIE *h₁éḱwos → Sanskrit aśva → ภาษาไทย 'อัศวะ, อัศวิน'",
            "hellenic": "PIE *h₁éḱwos → Greek hippos (ἵππος) → English hippopotamus (ม้าน้ำ!), Philip (ผู้รักม้า)",
            "italic": "PIE *h₁éḱwos → Latin equus → English equine, equestrian"
        },
        "english_cognates": [
            {
                "word": "equestrian",
                "derivation_path": "PIE *h₁éḱwos → Latin equester (เกี่ยวกับคนขี่ม้า) → English equestrian",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B2)",
                "usage_note": "อัศวิน / นักกีฬาขี่ม้า (อัศว- ↔ equus)"
            },
            {
                "word": "equine",
                "derivation_path": "PIE *h₁éḱwos → Latin equinus → English",
                "origin_language": "Latin",
                "difficulty": "Advanced / Science",
                "usage_note": "เกี่ยวกับสัตว์ตระกูลม้า"
            },
            {
                "word": "hippopotamus",
                "derivation_path": "Greek hippos (ม้า, รากเดียวกับ aśva) + potamos (แม่น้ำ) = ม้าแม่น้ำ!",
                "origin_language": "Greek",
                "difficulty": "General (A2)",
                "usage_note": "ฮิปโปโปเตมัส แปลว่า 'ม้าแม่น้ำ' (ม้า = hippos ↔ aśva)"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*h₁éḱwos", "meaning": "horse, swift animal"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "aśva (अश्व)", "meaning": "horse"},
            {"era": "Modern Thai", "stage": "Thai", "form": "อัศวะ / อัศวิน", "meaning": "ม้า, นักรบขี่ม้า"},
            {"era": "Modern English", "stage": "English", "form": "equestrian, equine, hippopotamus", "meaning": "ม้า, นักขี่ม้า"}
        ]
    },
    {
        "thai_word": "มหา",
        "category": "การกระทำและคุณลักษณะ",
        "pali_sanskrit_form": "mahā (महा) / mahant-",
        "pali_sanskrit_lang": "Sanskrit / Pali",
        "pali_sanskrit_meaning": "great, large, vast, mighty",
        "pie_root": "*meǵh₂- (หรือ *meǵ-)",
        "pie_meaning": "great, big",
        "sound_change_law": "Palatalization & Grimm's Law: PIE *meǵ- กลายเสียงเป็นสันสกฤต mahā-, กรีก megas (mega-), ละติน magnus, และเจอร์แมนิก *mikilaz → English much",
        "semantic_drift_score": "None (ยิ่งใหญ่/มโหฬาร)",
        "semantic_drift_note": "มหา (มหาวิทยาลัย, มหาราช, มโหฬาร) ↔ mega-, magnitude, magnificent, major, master, much",
        "pie_branch_split": {
            "indo_iranian": "PIE *meǵh₂- → Sanskrit mahā → ภาษาไทย 'มหา, มโหฬาร, มหึมา'",
            "hellenic": "PIE *meǵh₂- → Greek megas (μέγας) → English mega-, megaphone, megalopolis",
            "italic": "PIE *meǵh₂- → Latin magnus / maior → English magnificent, magnitude, major, mayor, master",
            "germanic": "PIE *meǵh₂- → Proto-Germanic *mikilaz → Old English miċel → English much"
        },
        "english_cognates": [
            {
                "word": "mega-",
                "derivation_path": "PIE *meǵh₂- → Greek megas → English prefix mega-",
                "origin_language": "Greek",
                "difficulty": "General (A1)",
                "usage_note": "มหา- ↔ mega-: ความหมายและเสียงตรงกันเป๊ะ เช่น megaproject = มหาโครงการ!"
            },
            {
                "word": "magnificent",
                "derivation_path": "PIE *meǵh₂- → Latin magnificus (ทำสิ่งที่ยิ่งใหญ่) → English",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B2)",
                "usage_note": "งดงามตระการตา / มโหฬาร"
            },
            {
                "word": "major",
                "derivation_path": "PIE *meǵh₂- → Latin maior (ใหญ่กว่า/สำคัญกว่า) → English",
                "origin_language": "Latin",
                "difficulty": "General (A2)",
                "usage_note": "หลัก / สำคัญยิ่งใหญ่ (เช่น major issue)"
            },
            {
                "word": "much",
                "derivation_path": "PIE *meǵh₂- → Proto-Germanic *mikilaz → Old English miċel → English much",
                "origin_language": "Old English",
                "difficulty": "General (A1)",
                "usage_note": "มาก (ปริมาณมหาศาล)"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*meǵh₂-", "meaning": "great, big"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "mahā (महा)", "meaning": "great, grand"},
            {"era": "Modern Thai", "stage": "Thai", "form": "มหา / มโหฬาร", "meaning": "ยิ่งใหญ่, มหาศาล"},
            {"era": "Modern English", "stage": "English", "form": "mega-, magnificent, major, much", "meaning": "ยิ่งใหญ่, มาก"}
        ]
    },
    {
        "thai_word": "ครู",
        "category": "การกระทำและคุณลักษณะ",
        "pali_sanskrit_form": "guru (गुरु) / garu (บาลี)",
        "pali_sanskrit_lang": "Sanskrit / Pali",
        "pali_sanskrit_meaning": "heavy, weighty, respectable, teacher",
        "pie_root": "*gʷreh₂- (หรือ *gʷer-)",
        "pie_meaning": "heavy, weighty",
        "sound_change_law": "Grimm's Law: PIE voiced labiovelar *gʷ- กลายเสียงเป็นสันสกฤต g- (guru = ผู้มีภูมิหนักแน่น), ละติน gr- (gravis = หนัก) และเจอร์แมนิก *k-",
        "semantic_drift_score": "Medium (หนักแน่นด้วยปัญญา → ครูอาจารย์ / แรงโน้มถ่วง)",
        "semantic_drift_note": "ครู/คุรุ (เดิมแปลว่า 'ผู้หนักแน่นด้วยภูมิความรู้และคุณธรรม') ↔ grave (สุขุม/หนักหน่วง), gravity (แรงดึงดูด/ความโน้มถ่วงโลก!), grief (ความเศร้าหนักอก)",
        "pie_branch_split": {
            "indo_iranian": "PIE *gʷreh₂- → Sanskrit guru → Pali garu → ภาษาไทย 'ครู, คุรุ, ครุศาสตร์'",
            "italic": "PIE *gʷreh₂- → Latin gravis (หนัก) → English grave, gravity, gravitate, aggravate, grief"
        },
        "english_cognates": [
            {
                "word": "guru",
                "derivation_path": "Sanskrit guru → English guru (ผู้เชี่ยวชาญ/ครูผู้รู้)",
                "origin_language": "Sanskrit loan in English",
                "difficulty": "Intermediate (B1)",
                "usage_note": "ครู / กูรู (ผู้รู้ในสาขาวิชา)"
            },
            {
                "word": "gravity",
                "derivation_path": "PIE *gʷreh₂- → Latin gravitas (ความหนักแน่น) → English gravity",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B1)",
                "usage_note": "ว้าว! แรงโน้มถ่วง (Gravity) และ คุรุ/ครู มาจากราก 'หนักแน่น' ตัวเดียวกันเป๊ะ!"
            },
            {
                "word": "grave",
                "derivation_path": "PIE *gʷreh₂- → Latin gravis → English grave (adj. สุขุมหนักแน่น)",
                "origin_language": "Latin",
                "difficulty": "Intermediate (B2)",
                "usage_note": "สุขุม / หนักหน่วงจริงจัง (เช่น grave responsibility = หน้าที่อันหนักอึ้ง)"
            },
            {
                "word": "grief",
                "derivation_path": "PIE *gʷreh₂- → Latin gravare → Old French grief → English grief",
                "origin_language": "Old French",
                "difficulty": "Intermediate (B2)",
                "usage_note": "ความเศร้าโศกหนักอึ้งในอก"
            }
        ],
        "timeline": [
            {"era": "~4500 BCE", "stage": "PIE", "form": "*gʷreh₂-", "meaning": "heavy, weighty"},
            {"era": "~1500 BCE", "stage": "Sanskrit", "form": "guru (गुरु)", "meaning": "heavy, venerable teacher"},
            {"era": "Modern Thai", "stage": "Thai", "form": "ครู / คุรุ", "meaning": "ผู้สั่งสอนวิชาการ"},
            {"era": "Modern English", "stage": "English", "form": "guru, gravity, grave, grief", "meaning": "กูรู, แรงโน้มถ่วง, หนักแน่น"}
        ]
    }
]
